    ...
    <div class="flex flex-col">
        <form method="post" action="{{ route('member_wallet') }}">
            ...
            <div class="grid gap-6 mb-6 mt-4 grid-cols-2 max-[1300px]:grid-cols-1 max-[1000px]:grid-cols-1 max-[770px]:grid-cols-1">
                ...
                <div>
                    {!! Form::select('wallet_address_request_status', $get_status_sel, @$search['wallet_address_request_status'], ['class' => 'bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500']) !!}
                </div>
                <div>
