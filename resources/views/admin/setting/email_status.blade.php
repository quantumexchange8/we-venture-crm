...
@section('contents')
    <div class="flex flex-row">
        <h1 class="flex-1 font-semibold text-2xl text-gray-500">@lang('public.setting') / @lang('public.email_status')</h1>
    ...
    <form class="space-y-6 md:w-1/2 sm:w-full" action="{{ $submit }}" method="post">
        ...
        <ul class="grid w-full gap-6 md:grid-cols-2">
            <li>
                <input type="radio" id="hosting-small" name="email_status_setting_type" value="personal" class="hidden peer" checked>
            ...
            <li>
                <input type="radio" id="hosting-big" name="email_status_setting_type" value="group" class="hidden peer">
