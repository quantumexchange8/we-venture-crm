...
@section('contents')
    <h1 class="font-semibold text-2xl text-gray-500">@lang('public.pamm')</h1>
        ...
        <form method="post" action="{{ route('news_listing') }}">
            ...
            <div class="grid gap-6 mb-6 mt-4 md:grid-cols-1">
                ...
                <div class="max-[755px]:flex max-[755px]:flex-col gap-2">
                    ...
                    <a href="{{ route('pamm_add') }}" class="inline-flex text-white py-1.5 px-8 rounded bg-[#2AC769] hover:bg-success-500 text-lg font-bold float-right items-center justify-center">
                        <div class="flex items-center">
                            <svg class="h-6 w-6 text-white"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
                            <span class="ml-4 text-md font-bold">@lang('public.add_pamm')</span>
                        </div>
                    </a>
                </div>
            </div>
    ...
    @if($pamms->isNotEmpty())
        <div class="relative overflow-x-auto mt-2 text-sm">
                    ...
                    <tr class="border-b odd:bg-[#FDFCF3] even:bg-[#F6F6F6]">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="{{ route('pamm_edit', $pamm->id) }}">
                                ...
                                <a href="javascript:void(0)" class="delete"
                                   ...
                                   data-te-ripple-init
                                   data-te-ripple-color="light" id="{{ $pamm->id }}">
            ...
            <div class="my-4">
                {!! $pamms->links('pagination::tailwind') !!}
            </div>
        </div>
    @else
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    <form method="POST" action="{{ route('pamm_delete') }}">
                        @csrf
                        <svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <div class="modal-body">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">@lang('public.delete_pamm_confirmation')</h3>
                            <input type="hidden" name="pamm_id" id="pamm_id">
                        </div>
