        ...
        <form method="post" action="{{ $submit }}" enctype="multipart/form-data">
            ...
            <div class="flex items-start rounded-xl bg-[#FDFCF3] shadow-lg">
                <div class="ml-4 px-12 pb-8 md:mt-6">
                    ...
                    <div class="mb-6">
                        <div>
                            <label for="countries" class="block mb-2 font-semibold text-orange-400 dark:text-white">@lang('public.country')</label>
                    ...
                    <button type="submit" class="text-white rounded-lg bg-[#1A8BFF] hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-700 font-semibold text-mdrounded-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-500 dark:hover:bg-[#050708]/30 float-right">@lang('public.update')</button>
                </div>
            </div>
        </form>
    </div>
