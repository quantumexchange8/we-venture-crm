    ...
    <div class="flex flex-col">
        <form method="post" action="{{ route('investment_listing') }}">
            ...
            <div class="grid gap-6 mb-6 mt-4 grid-cols-2 max-[1300px]:grid-cols-1 max-[1000px]:grid-cols-1 max-[770px]:grid-cols-1">
                ...
                <div>
                    {!! Form::select('filter_status', $get_status_sel, @$search['status'], ['class' => 'bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500', 'placeholder' => trans('public.select_status')]) !!}
                </div>
                <div>
                                ...
                                <div class="relative w-full max-w-2xl max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                            <h3 class="text-xl font-semibold text-orange-400 dark:text-white">
