...
@section('contents')
    ...
    <div class="grid grid-cols-3 gap-8 mt-4 max-[1350px]:grid-rows-auto max-[1350px]:grid-cols-2 max-[950px]:grid-cols-1">
        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #8FA6FF;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-sm ">@lang('public.total_group_sales')</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-sm ">@lang('public.total_withdrawals')</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #7BC6C9;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-sm ">@lang('public.total_commissions')</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #6495ED;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-sm ">@lang('public.total_members')</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #FF77A9;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-sm ">@lang('public.monthly_lot')</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #A3B8FF;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    <svg class="h-12 w-12 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M9 5H7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2V7a2 2 0 0 0 -2 -2h-2" />  <rect x="9" y="3" width="6" height="4" rx="2" />  <line x1="9" y1="12" x2="9.01" y2="12" />  <line x1="13" y1="12" x2="15" y2="12" />  <line x1="9" y1="16" x2="9.01" y2="16" />  <line x1="13" y1="16" x2="15" y2="16" /></svg>
                    <div class="flex-col" style="margin-left: 20px">
                        <h3 class="font-bold text-lg ">{{ number_format($lot_size_pool, 2) }}</h3>
                        <h6 class="font-semibold text-sm ">@lang('public.lot_size_pool')</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="accordion-open" data-accordion="open" class="mt-8 font-bold text-lg" data-active-classes="text-blue-400">
        @foreach($brokers as $broker)
            <h2 id="accordion-collapse-heading-{{$broker->id}}">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-blue-500 border border-blue-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 bg-[#f3f4fd] hover:bg-blue-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-{{$broker->id}}" aria-expanded="true" aria-controls="accordion-collapse-body-{{$broker->id}}">
            ...
            <div id="accordion-collapse-body-{{$broker->id}}" class="hidden" aria-labelledby="accordion-collapse-heading-{{$broker->id}}">
                <div class="p-5 border border-t-0 border-blue-200 dark:border-gray-700">
                    <span class="font-bold text-lg  text-sm text-blue-400 underline border-l-4 border-blue-400 pl-4 -ml-5">{{ $broker->name }}</span>
                    <div class="grid grid-cols-3 gap-8 mt-4 max-[1350px]:grid-rows-auto max-[1350px]:grid-cols-2 max-[950px]:grid-cols-1">
                        <div class="rounded overflow-hidden shadow-lg text-white" style="background: #8FA6FF;">
                            <div class="px-6 py-4">
                                <div class="flex items-center p-3">
