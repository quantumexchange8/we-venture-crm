                    ...
                    <tr class="border-b odd:bg-[#FFFFFF] even:bg-blue-100 text-sm">
                        ...
                        <td class="p-4 text-center">
                            <a href="javascript:void(0)" class="delete flex justify-center items-center"
                               ...
                               data-te-ripple-init
                               data-te-ripple-color="light" id="{{ $record->id }}" data-pamm-id="{{ $record->pamm_id }}">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <form method="post" action="{{ route('import_deposit') }}" enctype="multipart/form-data">@csrf
                        <h3 class="mb-4 text-xl font-semibold inline-block text-blue-500 dark:text-white">@lang('public.import_deposits')</h3>
                        ...
                        <div class="flex items-center  mb-4 justify-center w-full">
                            <button type="submit" class="text-white bg-blue-400 hover:bg-blue-600 border border-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="submit" value="import">@lang('public.import')</button>
                        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 2.25L15 12" />
        ...
        $(document).ready(function(e) {
            ...
            $('.delete').on('click', function() {
                var id = $(this).attr('id');
                var pammId = $(this).data('pamm-id');
                $(".modal-body #deposit_id").val(id);
                $(".modal-body #pamm_id").val(pammId);
            });
        });
