            ...
            <table class="w-full text-left">
                ...
                @foreach($records as $record)
                    <tr class="border-b odd:bg-[#FFFFFF] even:bg-blue-100">
                        ...
                        <td class="py-4 px-6">
                            @if($record->is_claimed == 'pending')
                                <span class="bg-blue-100 flex items-center justify-center text-blue-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 uppercase">@lang('public.'.$record->is_claimed)</span>
