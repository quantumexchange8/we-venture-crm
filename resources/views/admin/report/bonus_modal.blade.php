                                            ...
                                            <a class="relative inline-flex items-start mr-5" target="_blank" href="{{ route('member_details', @$record->upline->id) }}">
                                                <div class="relative inline-flex items-center justify-center w-20 h-20 overflow-hidden bg-orange-400 rounded-full dark:bg-gray-600">
                                                    @if (@$record->upline->profile_image)
                                                        <img src="{{ asset('uploads/users/' .@$record->upline->profile_image)}}" id="profile_pic_preview" class="relative inline-flex items-center justify-center w-32 h-32 overflow-hidden bg-orange-400 rounded-full dark:bg-gray-600font-bold text-white dark:text-gray-300 text-4xl object-contain">
                                                    @else
