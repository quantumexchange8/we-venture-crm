...
@section('contents')
    ...
    <form class="space-y-6" action="{{ $submit }}" enctype="multipart/form-data" method="post">
        ...
        <div>
            ...
            @endif
            <label for="content" class="block mb-2 font-bold text-[#FFA168] dark:text-white">@lang('public.news_image')</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                <h4 class="block font-bold text-[#FFA168] dark:text-white">@lang('public.action')</h4>
                <div>
