...
@section('contents')
    <div class="flex flex-row">
        ...
        <a href="{{ route('event_listing') }}" class="text-xl font-semibold text-[#3F83F8]">@lang('public.back')</a>
    </div>

    <form class="space-y-6" action="{{ $submit }}" enctype="multipart/form-data" method="post">
        @csrf
        <div>
            <label for="event_title" class="block mb-2 font-bold text-[#3F83F8] dark:text-white">@lang('public.event_title')</label>
        ...
        <div>
            ...
            @endif
            <label for="content" class="block mb-2 font-bold text-[#3F83F8] dark:text-white">@lang('public.event_image')</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                <div>
                    <h3 class="block mb-2 font-bold text-[#3F83F8] dark:text-white">@lang('public.visible')</h3>
                ...
                <div>
                    <h3 class="block mb-2 font-bold text-[#3F83F8] dark:text-white">@lang('public.popup_status')</h3>
                    <label class="relative inline-flex items-center cursor-pointer">
        ...
        @if($title == 'Add')
            <button type="submit" class="w-full text-white bg-[#3F83F8] hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">@lang('public.create_event')</button>
        @elseif($title = 'Edit')
