        ...
        <form method="post" action="{{ route('daily_monthly_deposits_listing') }}">
            ...
            <div class="grid gap-6 mb-6 mt-4 grid-cols-3 max-[1600px]:grid-cols-2 max-[1100px]:grid-cols-1">
                ...
                <div class="max-[655px]:flex max-[655px]:flex-col gap-2">
                    <select id="filter_type" name="filter_type" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="max-[755px]:flex max-[755px]:flex-col gap-2">
                    ...
                    <a  class=" text-white py-2 px-5 rounded rounded bg-[#3F83F8] hover:bg-blue-400 text-md font-bold float-right">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2">
            <table class="w-full text-left">
                ...
                @foreach($records as $record)
                    <tr class="border-b odd:bg-white even:bg-blue-100 text-sm">
