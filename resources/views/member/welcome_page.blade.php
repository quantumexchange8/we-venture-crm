...
@section('contents')
        ...
        <div class="grid grid-cols-2 max-[1000px]:grid-cols-1 gap-6 mb-6">
            <div class="w-full bg-blue-100 border border-gray-200 rounded-lg shadow hover:shadow-xl dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-end px-4 pt-4">
                    <button id="dropdownButton" data-dropdown-toggle="dropdown" class="inline-block text-gray-500 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5" type="button">
                    ...
                    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2" aria-labelledby="dropdownButton">
                            <li>
                                <a href="{{ route('member_profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">@lang('public.profile')</a>
                            </li>
                            <li>
                                <a href="{{ route('member_change_password') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">@lang('public.change_password')</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="flex flex-col items-center">
                    <div class="flex-shrink-0 grow-0 mb-2">
                        ...
                        @else
                            <img src="{{url('/img/profile.png')}}" class="w-24 h-24 rounded-full shadow-lg bg-blue-500" alt="">
                        @endif
                    </div>
                ...
                <!-- <div class="p-6">
                    <h5 class="mb-4 text-xl font-bold text-blue-500 dark:text-gray-400">
            ...
            <div class="w-full p-6 bg-blue-100 border border-gray-200 rounded-lg shadow hover:shadow-xl sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h2 class="mb-6 text-2xl font-bold tracking-tight text-blue-500 dark:text-white">@lang('public.investment')</h2>
                ...
                @else
                    <div class="mb-6 font-normal text-gray-700 dark:text-gray-400">
                        <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Coming Soon</span>
                    </div>
                @endif

                <a href="{{ route('investment.portfolio') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <!-- news -->
        <div class="max-w p-6 bg-blue-100 border border-gray-200 rounded-lg shadow hover:shadow-xl dark:bg-gray-800 dark:border-gray-700">
            @if(!empty($news))
                <h2 class="mb-6 underline text-2xl font-bold tracking-tight text-blue-500 dark:text-white">{{ $news->title }}</h2>
                <div class="mb-6 font-normal text-gray-700 dark:text-gray-400">
                ...
                <a href="{{ route('member_dashboard') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    @lang('public.read_more')
                    <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
            @else
                <p class="text-xl text-blue-500">@lang('public.welcome_back'), {{ auth()->user()->name }}!</p>
            @endif
                ...
                <div
                    class="pointer-events-auto relative flex max-h-[100%] w-full flex-col overflow-hidden rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                        <div
                            ...
                            <h5
                                class="text-xl font-medium leading-normal text-blue-500 dark:text-neutral-200"
