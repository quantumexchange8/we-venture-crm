        ...
        <nav class="flex mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-lg font-semibold">
                ...
                <div class="flex items-center">
                    ...
                    <a href="#" class="ml-1  text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{$user->name}}</a>
                </div>
                </li>
                <li>
                <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <p href="#" class="ml-1  text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">@lang('public.view_deposit')</p>
                </div>
                </li>
            </ol>
        </nav>
        <div class="grid grid-cols-6 w-auto max-[1250px]:grid-cols-4">
            ...
            <form  action="{{ url("member/deposit/$user->id") }}" method="post"  class="flex max-[1250px]:flex-col gap-3 mb-4">
                ...
                <div class="w-4/12 mr-4  max-[1250px]:w-full">
                    <select id="broker" name="filter_broker" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <button type="submit" name="submit" value="search" class="max-[1250px]:justify-center text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg p-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div class="col-span-2 px-4  max-[1250px]:col-span-4">
                <div class=" bg-blue-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto text-center pb-4">
                    <div class="py-12 bg-blue-500 w-full rounded-lg">
                    ...
                    @if ($user->profile_image)
                        <img src="{{ asset('uploads/users/' .$user->profile_image)}}" class="rounded-full -mt-10 w-20 h-20 mx-auto text-blue-500 bg-rose-200 p-2 drop-shadow-2xl mb-2"></img>
                    @else
                        <img src="{{url('/img/profile.png')}}" class="rounded-full -mt-10 w-20 h-20 mx-auto text-blue-500 bg-rose-200 p-2 drop-shadow-2xl mb-2"></img>
                    @endif
                    <div class=" bg-blue-100 w-full rounded-lg">
                        @foreach($broker_group as $group)
                            <div class="p-2">
                                <h5 class="text-xl font-semibold tracking-tight text-blue-500"> {{$group->broker->name}} </h5>
