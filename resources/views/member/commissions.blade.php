        ...
        <nav class="flex mb-4 max-[1000px]:flex-col" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-xl font-semibold mb-4">
                ...
                <div class="flex items-center">
                    ...
                    <p href="#" class="ml-1  text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">@lang('public.commissions')</p>
                </div>
                </li>
            </ol>
            ...
            <div class="px-4">
                <form action="{{ url('member/commissions') }}"  method="post"  class="grid grid-cols-2 gap-3 mb-4 max-[1300px]:grid-cols-2 max-[1000px]:grid-cols-1">
                    ...
                    <div class="w-full mr-4  max-[1000px]:w-full">
                        <select id="broker" name="filter_broker" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
