        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-members" class="{{ request()->is('admin/member/*') ? '' : 'hidden' }} py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('member_profile_request') }}" class="{{ request()->is('admin/member/member_profile_request') ? 'text-sm font-semibold text-orange-400' : 'text-sm font-semibold text-gray-500'}} flex items-center w-full p-2 text-base font-semibold transition duration-75 rounded-lg pl-11 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500">@lang('public.member_profile')
                            @if($userProfileRequest > 0)
                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-yellow-200 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $userProfileRequest }}</span>
                            @endif
                        </a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="dropdown-report" class="{{ request()->is('admin/report/*') ? '' : 'hidden' }} py-2 space-y-2">
                    ...
                    <li>
                        <button type="button" class="flex items-center w-full p-2 transition duration-75 rounded-lg pl-8 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500" aria-controls="dropdown-networks" data-collapse-toggle="dropdown-networks-child">
                            <span class="flex-1 ml-3 text-left whitespace-nowrap text-sm {{ request()->is('admin/report/network/*') ? 'font-semibold text-lg text-orange-400' : 'font-semibold text-lg text-gray-500'}}" sidebar-toggle-item>@lang('public.network')
                            </span>
                            <svg sidebar-toggle-item class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>
                    ...
                    <li>
                        <a href="{{ route('world_pool') }}" class="{{ request()->is('admin/report/world_pool') ? 'text-sm font-semibold text-orange-400' : 'text-sm font-semibold text-gray-500'}} flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500">
                            ...
                            @if($worldPoolRequest > 0)
                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-yellow-200 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $worldPoolRequest }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
            ...
            <li>
                ...
                @endphp
                <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown_investment" data-collapse-toggle="dropdown_investment">
                    ...
                    <span class="flex-1 ml-1 text-left whitespace-nowrap {{ request()->is('admin/investment/*') ? 'font-semibold text-lg text-orange-400' : 'font-semibold text-lg text-gray-500'}}" sidebar-toggle-item>@lang('public.investment')
                ...
                <ul id="dropdown_investment" class="{{ request()->is('admin/investment/*') ? '' : 'hidden' }} py-2 space-y-2">
                    <li>
                    <button type="button" class="flex items-center w-full p-2 transition duration-75 rounded-lg pl-8 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500" aria-controls="dropdown_investment" data-collapse-toggle="dropdown-investment-child">
                            <span class="flex-1 ml-3 text-left whitespace-nowrap text-sm {{ request()->is('admin/investment/add_portfolio') || request()->is('admin/investment/portfolio_edit/*') || request()->is('admin/investment/portfolio_listing') ? 'font-semibold text-lg text-orange-400' : 'font-semibold text-lg text-gray-500'}}" sidebar-toggle-item>@lang('public.portfolio')
                            </span>
                        <svg sidebar-toggle-item class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </button>
                    ...
                    <li>
                        <a href="{{ route('investment_listing') }}" class="{{ request()->is('admin/investment/investment_listing') ? 'text-sm font-semibold text-orange-400' : 'text-sm font-semibold text-gray-500'}} flex items-center w-full p-2 text-base font-semibold transition duration-75 rounded-lg pl-11 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500">@lang('public.listing')
                            @if($investment_count > 0)
                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-yellow-200 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $investment_count }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul id="dropdown-setting" class="{{ request()->is('admin/setting/*') ? '' : 'hidden' }} py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('setting_lot_size') }}" class="{{ request()->is('admin/setting/setting_lot_size') ? 'text-sm font-semibold text-orange-400' : 'text-sm font-semibold text-gray-500'}} flex items-center w-full p-2 text-base font-semibold transition duration-75 rounded-lg pl-11 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500">@lang('public.lot_size')</a>
                    </li>
                </ul>
            </li>
            <li>
