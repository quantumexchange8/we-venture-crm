        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8 bg-blue-100 rounded-lg">
            ...
            <form method="post" action="{{ url('forgot-password') }}">
                ...
                <div class="form-group mb-6">
                    <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-blue-500 font-semibold">@lang('public.insert_email')</label>
                ...
                <button type="submit" class="save_btn w-full px-6 py-2.5 bg-blue-500 text-white font-medium text-sm leading-tight rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out">@lang('public.send_email')</button>
